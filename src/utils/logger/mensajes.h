...
//GAME
#define ERROR_MIN_PLAYERS "El juego no puede iniciar con menos de 4 jugadores."
#define MENSAJE_INICIO_JUEGO "Iniciando juego"
#define MENSAJE_FIN_JUEGO "Fin de juego"
#define MENSAJE_CANTIDAD_JUGADORES "Cantidad de jugadores: "
#define ERROR_CREACION_TMP_FILE "Error al querer crear archivo concudaring.tmp"
#define ERROR_INICIO_MEMORIA "Error al iniciar memoria compartida"
